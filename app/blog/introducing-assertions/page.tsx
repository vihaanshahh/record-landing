          ...
          <article className="flex-1 min-w-0 order-1 lg:order-2">
            ...
            >
              ...
              <div className="space-y-5 text-[#646464] font-light leading-relaxed text-base">
                ...
                <p>
                  We heard this from teams over and over: &ldquo;We love the recordings, but we need
                  them to actually fail.&rdquo; So we built assertions directly into the agent loop.
